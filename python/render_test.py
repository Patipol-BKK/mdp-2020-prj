...
# instr_list = ['PS|FW040', 'PS|DM125', 'PS|FL060', 'PS|FR060', 'PS|DM225', 'PS|FR023', 'PS|FR067', 'PS|FW045', 'PS|FL090', \
# 			  'PS|FW025', 'PS|FL090', 'PS|FW090', 'PS|FL090', 'PS|DR200', 'PS|FW070', 'PS|FL090', 'PS|FW020', 'PS|FR090', 'PS|DM115']

instr_list = ['PS|FW040', 'PS|DM125', 'PS|FL060', 'PS|FR060', 'PS|DM225', 'PS|FR023', 'PS|BR023', 'PS|FL090', 'PS|FR090',
                          'PS|FW025', 'PS|FR090', 'PS|FW090', 'PS|FR090', 'PS|DR200', 'PS|FW070', 'PS|FR090', 'PS|FW020', 'PS|FL090', 'PS|DM115']

instr_list = ['PS|DM135', 'PS|FL053', 'PS|FR053', 'PS|DM245', 'PS|FR025','pic', 'PS|BR025', 'PS|FL070', 'PS|FR070', 'PS|FW010', 'PS|FR090', 'PS|FW045', 'PS|FR090', 'PS|DR200', 'PS|FW045', 'PS|FR090', 'PS|FL090', 'PS|DM115']
# instr_list = 
...
collided_cells = get_collided_cells(
    (0.5, 10.5, 90), instr_list, obstacles, 20, 40)

plot_collided_cells(collided_cells, 20, 40)
plot_instr((0.5, 10.5, 90), instr_list, obstacles)
    ...
    if instr[3] == 'F' or instr[3] == 'B':
        if instr[4] == 'L':
            while car.servo_angle > -30:
                ...
                plt.clf()
                collided_cells = update_collided_cells(
                    car.pos, collided_cells, 20, 20)
